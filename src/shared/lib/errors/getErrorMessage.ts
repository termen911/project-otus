...
export const getErrorMessage = (code: ErrorCode, field?: string): string => {
  ...
  switch (code) {
    case ErrorCode.ERR_FIELD_REQUIRED:
      return field
        ? t('errors.ERR_FIELD_REQUIRED', { field })
        : t('errors.ERR_FIELD_REQUIRED_DEFAULT');

    case ErrorCode.ERR_INCORRECT_EMAIL_OR_PASSWORD:
      return t('errors.ERR_INCORRECT_EMAIL_OR_PASSWORD');

    case ErrorCode.ERR_ACCOUNT_ALREADY_EXIST:
      return t('errors.ERR_ACCOUNT_ALREADY_EXIST');

    case ErrorCode.ERR_INCORRECT_PASSWORD:
      return t('errors.ERR_INCORRECT_PASSWORD');

    case ErrorCode.ERR_INVALID_PASSWORD:
      return t('errors.ERR_INVALID_PASSWORD');

    case ErrorCode.ERR_NOT_VALID:
      return t('errors.ERR_NOT_VALID');

    case ErrorCode.ERR_AUTH:
      return t('errors.ERR_AUTH');

    case ErrorCode.ERR_NO_FILES:
      return t('errors.ERR_NO_FILES');

    case ErrorCode.ERR_NOT_ALLOWED:
      return t('errors.ERR_NOT_ALLOWED');

    case ErrorCode.ERR_NOT_FOUND:
      return t('errors.ERR_NOT_FOUND');

    case ErrorCode.ERR_VALIDATION_ERROR:
      return t('errors.ERR_VALIDATION_ERROR');

    case ErrorCode.ERR_INVALID_QUERY_PARAMS:
      return t('errors.ERR_INVALID_QUERY_PARAMS');

    case ErrorCode.ERR_INTERNAL_SERVER:
      return t('errors.ERR_INTERNAL_SERVER');
